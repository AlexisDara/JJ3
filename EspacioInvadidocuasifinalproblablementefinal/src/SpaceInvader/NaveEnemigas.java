...
public class NaveEnemigas {
    ...
    public NaveEnemigas(int x, int y, int tipo, String rutaImagen) {
        ...
        try {
            if (rutaImagen != null && (rutaImagen.startsWith("/") || rutaImagen.contains(".png"))) {
                java.net.URL url = getClass().getResource("/images/zombie.png");
                if (tipo == 1 && url != null) {
    ...
    public NaveEnemigas(int x, int y, int tipo, String rutaImagen, String rutaImagenDaniada) {
        ...
        try {
            this.imagen = new ImageIcon(rutaImagen).getImage();
            this.imagenDaniada = new ImageIcon(rutaImagenDaniada).getImage();
            this.imagenCargada = (this.imagen != null && this.imagen.getWidth(null) > 0);
        } catch (Exception e) {
            this.imagenCargada = false;
        }
    ...
    public static String getRutaImagenPorTipo(int tipo) {
        switch (tipo) {
            case 1:
                return "SpaceInvader/zombi1.png";
            case 2:
                return "imagenes/nave_amarilla.png";
            case 3:
                return "imagenes/nave_violeta.png";
            default:
                return "imagenes/nave_roja.png";
        }
    }
