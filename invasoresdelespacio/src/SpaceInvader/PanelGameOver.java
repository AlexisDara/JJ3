...
public class PanelGameOver extends JPanel {
    ...
    public PanelGameOver(int puntos, Main mainFrame) {
        ...
        imagenDerrota = new ImageIcon("src/images/Derrota.jpg").getImage();
        setFocusable(true);
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Dibuja la imagen de derrota como fondo
        if (imagenDerrota != null) {
            g.drawImage(imagenDerrota, 0, 0, Main.SCREEN_WIDTH, Main.SCREEN_HEIGHT, this);
        } else {
